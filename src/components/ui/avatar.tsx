...
function AvatarImage({ className, ...props }: React.ComponentProps<"img">) {
	...
	return (
		// biome-ignore lint/performance/noImgElement: Clerk avatar hosts are dynamic and this primitive needs native load/error state without a global Next image allowlist.
		<img
