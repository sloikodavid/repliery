...
function ItemGroup({ className, ...props }: React.ComponentProps<"div">) {
	return (
		// biome-ignore lint/a11y/useSemanticElements: Items can render links or generic content, so a native list would require invalid or misleading list-item semantics.
		<div
			role="list"
